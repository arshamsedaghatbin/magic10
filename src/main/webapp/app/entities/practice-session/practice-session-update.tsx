  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic10App.practiceSession.home.createOrEditLabel" data-cy="PracticeSessionCreateUpdateHeading">
            <Translate contentKey="magic10App.practiceSession.home.createOrEditLabel">Create or edit a PracticeSession</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('magic10App.practiceSession.tiltle')}
              ...
              />
              <ValidatedField
                label={translate('magic10App.practiceSession.action')}
              ...
              <ValidatedField
                ...
                name="practiceId"
                data-cy="practice"
                label={translate('magic10App.practiceSession.practice')}
                type="select"
              >
                <option value="" key="0" />
                {practices
