    ...
    <Row>
      <Col md="8">
        <h2 data-cy="bookMarkActionDetailsHeading">
          <Translate contentKey="magic10App.bookMarkAction.detail.title">BookMarkAction</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="magic10App.bookMarkAction.action">Action</Translate>
          </dt>
