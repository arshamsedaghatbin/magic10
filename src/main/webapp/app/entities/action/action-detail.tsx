    ...
    <Row>
      <Col md="8">
        <h2 data-cy="actionDetailsHeading">
          <Translate contentKey="magic10App.action.detail.title">Action</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="magic10App.action.title">Title</Translate>
            </span>
          </dt>
          <dd>{actionEntity.title}</dd>
          <dt>
            <span id="photoUrl">
              <Translate contentKey="magic10App.action.photoUrl">Photo Url</Translate>
            </span>
          </dt>
          <dd>{actionEntity.photoUrl}</dd>
          <dt>
            <span id="photo">
              <Translate contentKey="magic10App.action.photo">Photo</Translate>
            </span>
          </dt>
          <dd>
            {actionEntity.photo ? (
          ...
          <dt>
            <span id="code">
              <Translate contentKey="magic10App.action.code">Code</Translate>
            </span>
          </dt>
          <dd>{actionEntity.code}</dd>
          <dt>
            <span id="video">
              <Translate contentKey="magic10App.action.video">Video</Translate>
            </span>
          </dt>
          <dd>
            {actionEntity.video ? (
          ...
          <dt>
            <span id="videoUrl">
              <Translate contentKey="magic10App.action.videoUrl">Video Url</Translate>
            </span>
          </dt>
          <dd>{actionEntity.videoUrl}</dd>
          <dt>
            <span id="masterDescription">
              <Translate contentKey="magic10App.action.masterDescription">Master Description</Translate>
            </span>
          </dt>
