  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic10App.practice.home.createOrEditLabel" data-cy="PracticeCreateUpdateHeading">
            <Translate contentKey="magic10App.practice.home.createOrEditLabel">Create or edit a Practice</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('magic10App.practice.title')} id="practice-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('magic10App.practice.photoUrl')}
              ...
              />
              <ValidatedBlobField
                label={translate('magic10App.practice.photo')}
                id="practice-photo"
                name="photo"
                data-cy="photo"
              ...
              />
              <ValidatedField
                label={translate('magic10App.practice.voiceUrl')}
              ...
              />
              <ValidatedBlobField
                label={translate('magic10App.practice.voiceFile')}
              ...
              />
              <ValidatedField
                label={translate('magic10App.practice.masterDescription')}
              ...
              />
              <ValidatedField
                label={translate('magic10App.practice.masterAdvice')}
              ...
              />
              <ValidatedField
                label={translate('magic10App.practice.briefMasterAdvice')}
